"""
Experiment 2: Full Fine-Tuning of TinyBERT.

This script loads a pre-trained TinyBERT model and fine-tunes all
its parameters on the processed complaint data. Serves as a
high-performance, high-cost baseline.
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Full fine-tuning of TinyBERT.")
    parser.add_argument("--data-dir", type=str, default="data/processed", help="Directory with processed data.")
    parser.add_argument("--output-dir", type=str, default="models/tinybert_full", help="Directory to save model and results.")
...
def main():
    ...
    setup_logging(log_dir=args.output_dir, log_file="train_full_finetune.log")
    ...
    logging.info(f"Loaded {args.base_model_name} for full fine-tuning. Trainable parameters: {total_params}")
